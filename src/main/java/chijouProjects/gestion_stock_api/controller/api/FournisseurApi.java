...
import static chijouProjects.gestion_stock_api.utils.Constants.FOURNISSEUR_ENDPOINT;
...
public interface FournisseurApi {
    ...
    @Operation(summary = "Enregistrer ou modifier un fournisseur",
            description = "Cette méthode permet de créer ou de modifier un fournisseur"
    )
    @ApiResponses(value = {
    ...
    @Operation(summary = "Rechercher un fourniseur par ID",
            description = "Cette méthode permet de chercher un fournisseur par son identifiant"
    )
    @ApiResponses(value = {
    ...
    @GetMapping(value = FOURNISSEUR_ENDPOINT + "/nom/{nom}", produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Rechercher un fournisseur par son nom",
            description = "Cette méthode permet de chercher un fournisseur par son nom",
            parameters = {
    ...
    @Operation(summary = "Renvoyer la liste des fournisseurs",
            description = "Cette méthode permet de retourner la liste des fournisseurs enregistrés",
            parameters = {
                    @Parameter(name= "X-Entreprise-Id", in = ParameterIn.HEADER, description = "ID de l'entreprise", required = false)
            }
    )
    ...
    @DeleteMapping(value = FOURNISSEUR_ENDPOINT + "/delete/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
